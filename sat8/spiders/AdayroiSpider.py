...
class AdayroiSpider(AbstractPriceSpider):
	name = "product_link"
	...
	configs = {
		'product_links' : '//*[@class="post-title"]/a/@href',
		'source' : 'www.adayroi.com',
		'title' : '//*[@class="item-title"]/text()',
		'price' : '//*[@class="item-price"]/text()'
	}